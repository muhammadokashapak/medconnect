...
async function main() {
  ...
  console.log("Seeding comprehensive detailed guidelines...");
  let idCounter = 1;
  ...
  // Delete all existing to avoid duplicate conflicts
  ...
  console.log("Seeded " + guidelinesToInsert.length + " HIGHLY DETAILED guidelines successfully.");
