          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-100">
            ...
            <div className="p-6">
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                Are you sure you want to delete your account? This action is <strong>permanent</strong> and <strong>cannot be undone</strong>. 
                All your posts, comments, messages, profile details, and clinical data will be wiped out from the system forever.
              </p>
              ...
              <div className="flex gap-3">
                ...
                <button 
                  ...
                  disabled={deleteLoading}
                  className="flex-1 px-6 py-2.5 bg-red-600 text-white font-bold rounded-lg shadow hover:bg-red-700 transition disabled:opacity-50 flex items-center justify-center"
                >
                  {deleteLoading ? (
                    <>
