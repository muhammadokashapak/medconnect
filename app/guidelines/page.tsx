    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button onClick={() => router.push("/knowledge")} className="text-sm font-medium text-gray-600 hover:text-gray-800">
                ...
                <div key={g.id} className="bg-white p-6 rounded-xl shadow border border-gray-100 flex flex-col justify-between hover:shadow-md transition">
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-gray-400 text-xs font-mono">{g.version}</span>
                    </div>
                    <h2 className="text-xl font-bold text-gray-900 mb-2 leading-tight">{g.title}</h2>
