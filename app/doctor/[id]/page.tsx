            ...
            <div className="relative flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-gray-200 pb-6">
              ...
              <div className="flex flex-wrap items-center gap-2 w-full md:w-auto md:pt-20 mt-2 md:mt-0">
                <button
                  ...
                  disabled={messaging}
                  className="flex-1 md:flex-initial bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg shadow-sm transition flex items-center justify-center gap-1.5 text-sm md:text-base disabled:opacity-60"
                >
                  <svg className="w-4 h-4 md:w-5 md:h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                ...
                {currentDoctorId && currentDoctorId !== doctor.id && (
                  <>
                    ...
                    <button
                      ...
                      className="bg-gray-200 hover:bg-gray-300 text-gray-900 p-2 rounded-lg transition flex items-center justify-center shrink-0"
                      title="Voice Call"
                    >
                    ...
                    <button
                      ...
                      title="Video Call"
                    >
                      <svg className="w-4 h-4 md:w-5 md:h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                    </button>

                    {doctor.appointment ? (
                      <button disabled className="flex-1 md:flex-initial bg-gray-100 text-gray-500 font-semibold py-2 px-4 rounded-lg cursor-not-allowed text-sm md:text-base flex items-center justify-center">
                        {doctor.appointment.status === "PENDING" ? "Pending Appt" : "Scheduled"}
                      </button>
                    ) : (
                      <button
                        onClick={() => setShowAppointmentModal(true)}
                        className="flex-1 md:flex-initial bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg shadow-sm transition flex items-center justify-center text-sm md:text-base"
                      >
                        Book Appt
                      </button>
                    )}
                ...
                <button
                  ...
                  title="Go Back"
                >
                  <svg className="w-4 h-4 md:w-5 md:h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                </button>
              </div>
            </div>
